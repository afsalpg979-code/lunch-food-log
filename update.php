...
$allowedMeals = [
    'Breakfast' => '08:00-09:00', 'Morning Snack' => '10:30-11:00',
    'Lunch' => '12:00-13:00', 'Evening Snack' => '16:30-17:00',
    'During Duty' => '20:00-21:00', 'Dinner' => '22:15-22:45'
];

$parsed = DateTime::createFromFormat('Y-m-d', $date);
if (!$id || !$parsed || $parsed->format('Y-m-d') !== $date || $food === '') {
    http_response_code(400); exit('Please enter a valid entry, date and food item.');
}
...
$stmt->execute([$date, $food, $quantity, $notes, $mealType, $allowedMeals[$mealType], $id]);
