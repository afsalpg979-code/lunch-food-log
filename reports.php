...
<select name="report" onchange="toggleCustom(this.value)" required>

<option value="">Select Report</option>

<option value="monthly"
<?= $report === 'monthly' ? 'selected' : '' ?>>
Monthly Report
</option>

<option value="six_months"
<?= $report === 'six_months' ? 'selected' : '' ?>>
Last 6 Months
</option>

<option value="yearly"
<?= $report === 'yearly' ? 'selected' : '' ?>>
Yearly Report
</option>

<option value="custom"
<?= $report === 'custom' ? 'selected' : '' ?>>
Custom Date Range
</option>
...
<a href="export.php?format=csv&start=<?= urlencode($start) ?>&end=<?= urlencode($end) ?>">
⬇️ CSV
</a>

<a href="export.php?format=xlsx&start=<?= urlencode($start) ?>&end=<?= urlencode($end) ?>">
⬇️ Excel
</a>
...
<p>No lunch entries found for this period.</p>
...
<td><?= htmlspecialchars($row['lunch_date']) ?></td>
...
toggleCustom("<?= htmlspecialchars($report) ?>");
